...
const DashboardCampaignContent = () => {
  ...
  return (
    <div className="bg-[#F7F0FF] max-h-ful">
      <div className="px-3 py-1 flex fixed top-0 left-0 right-0 ">
      <Link to="/dashboard"><h1 className="text-[#87255B] font-semibold text-[24px]">GiveHope</h1></Link>  
      </div>
      <div className="">
        <h1 className="font-bold text-center text-3xl pt-16 text-[#87255B]">
          About Campaign
        </h1>
        {dataCampaigns ? (
          <div>
            ...
            <div className="p-6 text-[#87255B]">
              ...
              <h1 className="mt-8 font-semibold">More about the campaign</h1>
...
export default DashboardCampaignContent;
